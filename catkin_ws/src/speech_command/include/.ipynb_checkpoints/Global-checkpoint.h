...
char* WAKEUP_RESPONSE_WAV = (char*)"~/audio/wakeup.wav";  
...
bool wait_for_awake_word = false;                                        // 等待用户说出唤醒词false
...
int serial_error = 0;
/*********************************用户可修改参数*******************************************/
#define DEV_ID "/dev/xfserial"                                            // 外接设备的串口号,若用语音控制机器人运动,则该串口号为机器人下位机
...
string appid = "5e159d11";                                               // 仅用于在线AIUI，用户可修改，普通用户每天500次
string key = "5d23f1fb72571f1c8a5ff4ef7b910723";                         // AIUI引擎Appid对应的AppKey
string offline_appid = "appid = d5930ae8";					 //仅用于离线命令词识别I，用户可修改.
