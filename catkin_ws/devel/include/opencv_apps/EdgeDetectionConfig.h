...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(EdgeDetectionConfig::AbstractParamDescriptionConstPtr(new EdgeDetectionConfig::ParamDescription<int>("edge_type", "int", 0, "Edge Detection Methods", "{'enum_description': 'An enum for Edge Detection Mehtods', 'enum': [{'srcline': 42, 'description': 'Sobel Derivatives', 'srcfile': '/home/jetson/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Sobel'}, {'srcline': 43, 'description': 'Laplace Operator', 'srcfile': '/home/jetson/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Laplace'}, {'srcline': 44, 'description': 'Canny Edge Detector', 'srcfile': '/home/jetson/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Canny'}]}", &EdgeDetectionConfig::edge_type)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(EdgeDetectionConfig::AbstractParamDescriptionConstPtr(new EdgeDetectionConfig::ParamDescription<int>("edge_type", "int", 0, "Edge Detection Methods", "{'enum_description': 'An enum for Edge Detection Mehtods', 'enum': [{'srcline': 42, 'description': 'Sobel Derivatives', 'srcfile': '/home/jetson/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Sobel'}, {'srcline': 43, 'description': 'Laplace Operator', 'srcfile': '/home/jetson/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Laplace'}, {'srcline': 44, 'description': 'Canny Edge Detector', 'srcfile': '/home/jetson/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Canny'}]}", &EdgeDetectionConfig::edge_type)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 42 "/home/jetson/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg"
      const int EdgeDetection_Sobel = 0;
//#line 43 "/home/jetson/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg"
      const int EdgeDetection_Laplace = 1;
//#line 44 "/home/jetson/catkin_ws/src/opencv_apps/cfg/EdgeDetection.cfg"
