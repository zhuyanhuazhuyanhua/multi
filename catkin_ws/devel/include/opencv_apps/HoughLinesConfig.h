...
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(HoughLinesConfig::AbstractParamDescriptionConstPtr(new HoughLinesConfig::ParamDescription<int>("hough_type", "int", 0, "Hough Line Methods", "{'enum_description': 'An enum for Hough Transform Mehtods', 'enum': [{'srcline': 42, 'description': 'Standard Hough Line', 'srcfile': '/home/jetson/catkin_ws/src/opencv_apps/cfg/HoughLines.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Standard_Hough_Transform'}, {'srcline': 43, 'description': 'Probabilistic Hough Line', 'srcfile': '/home/jetson/catkin_ws/src/opencv_apps/cfg/HoughLines.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Probabilistic_Hough_Transform'}]}", &HoughLinesConfig::hough_type)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      __param_descriptions__.push_back(HoughLinesConfig::AbstractParamDescriptionConstPtr(new HoughLinesConfig::ParamDescription<int>("hough_type", "int", 0, "Hough Line Methods", "{'enum_description': 'An enum for Hough Transform Mehtods', 'enum': [{'srcline': 42, 'description': 'Standard Hough Line', 'srcfile': '/home/jetson/catkin_ws/src/opencv_apps/cfg/HoughLines.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Standard_Hough_Transform'}, {'srcline': 43, 'description': 'Probabilistic Hough Line', 'srcfile': '/home/jetson/catkin_ws/src/opencv_apps/cfg/HoughLines.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Probabilistic_Hough_Transform'}]}", &HoughLinesConfig::hough_type)));
//#line 291 "/opt/ros/melodic/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 42 "/home/jetson/catkin_ws/src/opencv_apps/cfg/HoughLines.cfg"
      const int HoughLines_Standard_Hough_Transform = 0;
//#line 43 "/home/jetson/catkin_ws/src/opencv_apps/cfg/HoughLines.cfg"
